# API Contract - Municipal Police POC Backend

What the android and Web squads can rely on.
Read this before writing a client against the API.

This file is not an endpoint refrence. Endpoints fields and request bodies  are generated from the code at '/api/docs/' and are always current.
