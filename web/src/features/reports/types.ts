...
// ActivityFeedView response (/reports/activity/)
...
// DailySummaryView response (/reports/daily/summary/)
...
// WeeklySummaryView response (/reports/weekly/)
...
// OfficerReportView response (/reports/officer/)
